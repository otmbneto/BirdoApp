import os
import shutil
from birdo_zip import compact_folder
from datetime import datetime
from birdo_timeout import timeout


class FileObject(object):
    """Classe para criar metodos para manipulacao de arquivos e pastas no servidor do projeto usando o modulo os"""
...
class Server(object):
    """Classe para manipular arquivos no server do Projeto"""
    def __init__(self, paths_data):
        # Define server root values
        self.root = os.path.join(paths_data["root"], paths_data["projRoot"])
        self.status = None

        # Define Connection status
        self.check_connection()

        print "--server status is {0}".format(self.status)
    ...
    def check_connection(self):
        ...
        """
        try:
            self.status = "Online" if self.server_exists() else "Offline"
    ...
    def download_file(self, server_file_path, local_file_destination):
        ...
        try:
            ...
            print 'Fail to download file: {0} to {1}\n{2}'.format(server_file_path, local_file_destination, e)
            return False
        return True
    ...
    def update_file_content(self, server_file_path, data):
        ...
        try:
            ...
            print 'Fail to update file: {0}\n{1}'.format(server_file_path, e)
            return False
        return True
    ...
    def upload_file(self, server_file_path, local_file_path):
        ...
        try:
            ...
            print 'Fail to upload file: {0} to {1}\n{2}'.format(local_file_path, server_file_path, e)
            return False
        return True
    ...
    def upload_dir(self, server_dir, local_dir):
        ...
        try:
            ...
            print 'Fail to upload dir: {0} to {1}\n{2}'.format(local_dir, server_dir, e)
            return False
        return True
    ...
    def get_file_content(self, server_file):
        ...
        try:
            ...
            print 'Fail to get file content: {0}\n{1}'.format(server_file, e)
            content = False
        return content
    ...
    def make_dir(self, server_dir):
        ...
        try:
            ...
            print 'Fail to create dir: {0}\n{1}'.format(server_dir, e)
            return False
        return True
    ...
    def delete(self, item_path):
        ...
        try:
            ...
            print 'Fail to delete item: {0}\n{1}'.format(item_path, e)
            return False
        return True
    ...
    def download_dir_as_zip(self, server_dir, local_zip):
        ...
        try:
            ...
            print 'Fail to download dir: {0} as the zip {1}\n{2}'.format(server_dir, local_zip, e)
            return False
        return True
