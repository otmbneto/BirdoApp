...
/*
-------------------------------------------------------------------------------
Name:		addMatteLine_LEB.js

Description:	este script é um util para modificar a cena antes do render do projeto LEB;
...
function addMatteLine_LEB(){
	...
	//add matte lines
	add_lines_matte(projectDATA);
}
exports.addMatteLine_LEB = addMatteLine_LEB;


function add_lines_matte(proj_data){//add matte line e um write node para cada write node existente
