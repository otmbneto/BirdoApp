/*
-------------------------------------------------------------------------------
Name:			AST_updateMCs.js

Description:	Este Script é especifico do projeto ASTRO para atualizar os MCS do projeto (depois atualizamos o esquema mas este projeto ficou dessa forma

Usage:			Show/hide todos MC da cena 

Author:			Leonardo Bazilio Bentolila

Created:		Agosto, 2022 (update maio 2023)
...
function updateMCsASTRO(projectDATA){

	//mc script file text
	var ui_script = "function onCheckboxValueChanged(params, checkedVal){\n" +
...
exports.updateMCsASTRO = updateMCsASTRO;
